...
public class Rocket extends JFrame implements ActionListener {
    private Container c;
    ...
    public Rocket(String loggedInUsername) {
    ...
    private void initContainer() {
        ...
        jp1.setBackground(new Color(162, 31, 209));
        c.add(jp1);
        ...
        img = new ImageIcon("/Elitejersey/IMAGES/Rocket.png");
        img1 = new JLabel(img);
    ...
    public static void main(String[] args) {
        ...
        Rocket log = new Rocket(loggedInUsername);
    }
}
