...
public class OrderPanel extends JFrame implements ActionListener,MouseListener {
    ...
    public OrderPanel(String userName) {
        
        this.userName = userName;
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        this.setSize(1080, 520);
        this.setTitle("Ordered Product");
        ...
        if (!foundUserName) {
            JOptionPane.showMessageDialog(this, "No products found in the Orders Card.");
        }
        ...
        DeleteButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    // Refresh the UI
                    dispose();
                    OrderPanel frame = new OrderPanel(userName);
    ...
    private void loadFromFile() {
        try (BufferedReader br = new BufferedReader(new FileReader("/Elitejersey/Files/orderCard.txt"))) {
            String line;
            int index = 0;
    ...
    private void saveToFile() {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("/Elitejersey/Files/orderCard.txt"))) {
