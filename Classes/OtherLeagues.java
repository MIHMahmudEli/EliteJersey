...
public class OtherLeagues extends JFrame implements MouseListener,ActionListener {
    ...
    public OtherLeagues(String userName) {

        this.userName=userName;
        
        this.setDefaultCloseOperation(JFrame.DEFAULT_CURSOR);
        this.setSize(1280, 720);
        this.setLocationRelativeTo(null);
        this.setTitle("OtherLeagues");
        ...
        // Check the flag and show a message if no products are found
        if (!foundProductsInCategory) {
            JOptionPane.showMessageDialog(this, "No products found in the Other League category.");
    ...
    public void initContainer() {
        ...
        for ( int  i = 0; i < imagePaths.length; i++) {
            if (productTitle[i] != null && imagePaths[i] != null && classPrices[i] != null && productCategory[i] != null
                    && productCategory[i].equals("Other League")) {
                count++;
            }
        }
        ...
        // Add panels to the gridPanel
    for (int i = 0; i < imagePaths.length; i++) {
        if (productTitle[i] != null && imagePaths[i] != null && classPrices[i] != null && productCategory[i] != null && productCategory[i].equals("Other League")) {
                gridPanel.add(createPanel(productTitle[i], imagePaths[i], classPrices[i]));
                foundProductsInCategory = true;
            }
        }
    ...
    private JPanel createPanel(String productTitle, String imagePath, String classPrices) {
        ...
        newButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                LeaguePanel targetPanel = (LeaguePanel) new ProductClass4(productTitle, imagePath, classPrices, userName);
    ...
    public void mouseExited(MouseEvent e) {
        if(e.getSource()==button1 || e.getSource()==button2 ||e.getSource()==button4 || e.getSource()==button3 ||e.getSource()==button6 ){
