...
public class CartPanel extends JFrame implements ActionListener,MouseListener {
    ...
    public CartPanel(String userName) {
        ...
        if (!foundUserName) {
            JOptionPane.showMessageDialog(this, "No products found in the Shopping Card.");
        }
    }
        ...
        DeleteButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    // Refresh the UI
                    dispose();
                    CartPanel frame = new CartPanel(userName);
