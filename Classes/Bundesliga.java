...
public class Bundesliga extends JFrame implements MouseListener,ActionListener {
    ...
    public Bundesliga(String userName) {
    ...
    public void initContainer() {
        ...
        for ( int  i = 0; i < imagePaths.length; i++) {
            if (productTitle[i] != null && imagePaths[i] != null && classPrices[i] != null && productCategory[i] != null
                    && productCategory[i].equals("Bundesliga")) {
                count++;
            }
        }
        ...
        gridPanel.setPreferredSize(new Dimension(310, 250)); // Adjust the size as needed
        ...
        // Add panels to the gridPanel
    for (int i = 0; i < imagePaths.length; i++) {
        if (productTitle[i] != null && imagePaths[i] != null && classPrices[i] != null && productCategory[i] != null && productCategory[i].equals("Bundesliga")) {
                gridPanel.add(createPanel(productTitle[i], imagePaths[i], classPrices[i]));
                foundProductsInCategory = true;
            }
        }
    ...
    private JPanel createPanel(String productTitle, String imagePath, String classPrices) {
        ...
        newButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                LeaguePanel targetPanel = (LeaguePanel) new ProductClass1(productTitle, imagePath, classPrices, userName);
    ...
    public void mouseExited(MouseEvent e) {
        if(e.getSource()==button1 || e.getSource()==button2 ||e.getSource()==button4 || e.getSource()==button5 ||e.getSource()==button6 ){
