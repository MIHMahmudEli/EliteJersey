...
public class Bkash extends JFrame implements ActionListener {
    ...
    public Bkash(String loggedInUsername) {
    ...
    private void initContainer() {
        ...
        jp1.setBackground(new Color(224, 17, 95));
        c.add(jp1);
        ...
        img = new ImageIcon("/Elitejersey/IMAGES/bkash.png");
        img1 = new JLabel(img);
        ...
        if (e.getSource() == b1) {
            if (numberEmpty || pinEmpty) {
                ...
                if (number.length() != 11) {
                    ...
                    JOptionPane.showMessageDialog(null, "Please enter your correct pin number.", "Warning!",
                            JOptionPane.WARNING_MESSAGE);
                }  else {
    ...
    public static void main(String[] args) {
        String loggedInUsername = "m";
        Bkash log = new Bkash(loggedInUsername);
    }
}
