...
public class PremeirLeague extends JFrame implements MouseListener,ActionListener {
    ...
    public PremeirLeague(String userName) {
    ...
    public void initContainer() {
        ...
        for ( int i = 0; i < imagePaths.length; i++) {
            if (productTitle[i] != null && imagePaths[i] != null && classPrices[i] != null && productCategory[i] != null
                    && productCategory[i].equals("Premeir League")) {
               count++;
            }
        }
        ...
        // Add panels to the gridPanel
    for ( int i = 0; i < imagePaths.length; i++) {
        if (productTitle[i] != null && imagePaths[i] != null && classPrices[i] != null && productCategory[i] != null && productCategory[i].equals("Premeir League")) {
                gridPanel.add(createPanel(productTitle[i], imagePaths[i], classPrices[i]));
                foundProductsInCategory = true;
            }
        }
    ...
    private JPanel createPanel(String productTitle, String imagePath, String classPrices) {
        ...
        newButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                LeaguePanel targetPanel = (LeaguePanel) new ProductClass5(productTitle, imagePath, classPrices, userName);
    ...
    public void mouseExited(MouseEvent e) {
        if(e.getSource()==button3 || e.getSource()==button2 ||e.getSource()==button4 || e.getSource()==button5 ||e.getSource()==button6 ){
